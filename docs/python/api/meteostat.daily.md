...
- **Type:** _Function_
- **Source Code:** [GitHub](https://github.com/meteostat/meteostat/blob/main/meteostat/api/daily.py)
...
| `parameters` | Requested meteorological parameters.         | [`List[Parameter]`](./meteostat.Parameter.md)                                                                                                                                                                                                                 | [Default parameters](/parameters?g=daily&d=1) |
| `providers`  | Requested data providers.                    | [`List[Provider]`](./meteostat.Provider.md)                                                                                                                                                                                                                   | `[Provider.DAILY]`                            |
