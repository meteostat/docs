---
title: Animated Temperature Heatmap
...
The full script is available on GitHub: [generate_germany_tmax_gif.py](https://github.com/meteostat/docs/blob/main/examples/generate_germany_tmax_gif.py)
